...
static void AudioI2sOutParamsSet(void)
{
	...
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_MIX_MCLK_GPIO), GET_I2S_GPIO_MODE(I2S_MIX_MCLK_GPIO));//mclk
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_MIX_LRCLK_GPIO),GET_I2S_GPIO_MODE(I2S_MIX_LRCLK_GPIO));//lrclk
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_MIX_BCLK_GPIO), GET_I2S_GPIO_MODE(I2S_MIX_BCLK_GPIO));//bclk
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_MIX_DOUT_GPIO), GET_I2S_GPIO_MODE(I2S_MIX_DOUT_GPIO));//do
...
bool I2S_MixInit(void)
{
	...
	if(!AudioCoreSourceIsInit(I2S_MIX_SOURCE_NUM))
	{
		...
		GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_MIX_DIN_GPIO), GET_I2S_GPIO_MODE(I2S_MIX_DIN_GPIO));//di
	#endif
