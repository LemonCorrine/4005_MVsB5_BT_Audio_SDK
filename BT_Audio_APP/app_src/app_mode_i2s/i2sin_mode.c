...
#endif
#ifdef I2S_DIN_GPIO
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_DIN_GPIO), GET_I2S_GPIO_MODE(I2S_DIN_GPIO));//di
#endif
...
bool I2SInPlayDeinit(void)
{
	...
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_MCLK_GPIO), 0);//mclk
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_LRCLK_GPIO),0);//lrclk
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_BCLK_GPIO), 0);//bclk
#ifdef I2S_DIN_GPIO
	GPIO_PortAModeSet(1 << GET_I2S_GPIO_INDEX(I2S_DIN_GPIO), 0);//di
#endif
