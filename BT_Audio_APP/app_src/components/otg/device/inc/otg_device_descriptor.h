...
#if HID_DATA_FUN_EN
	//一共4个接口
	0x09,0x02,163-3,0x00,0x04,0x01,0x00,0x80,0x32,
#else
	0x09,0x02,163-18-3,0x00,0x03,0x01,0x00,0x80,0x32,
#endif
	//0 audio control Interface
	0x09,0x04,0x00,0x00,0x00,0x01,0x01,0x00,0x00,
...
const uint8_t ConfigDescriptor_Tab(AUDIO_MIC_AUDIO)[] =
{
#if HID_DATA_FUN_EN
	//一共a个接口
	0x09,0x02,W_TOTAL_LENGTH(0xEA+USER_CONFIG_DESCRIPTOR_SIZE+18+0x69),0x07,0x01,0x00,0x80,0x32,
#else
	0x09,0x02,W_TOTAL_LENGTH(0xEA+USER_CONFIG_DESCRIPTOR_SIZE+0x69),0x06,0x01,0x00,0x80,0x32,
#endif
	//0 audio control Interface
	0x09,0x04,0x00,0x00,0x00,0x01,0x01,0x00,0x00,
	0x0A,0x24,0x01,0x00,0x01,W_TOTAL_LENGTH(0x4B+PACKET_CHANNELS_NUM+MIC_CHANNELS_NUM),0x02,0x01,0x02,
	...
	0x09,0x24,0x01,0x00,0x01,W_TOTAL_LENGTH(0x26+SPEAKER1_CHANNELS_NUM),0x01,0x06,
	0x0C,0x24,0x02,0x09,0x01,0x01,0x00,SPEAKER1_CHANNELS_NUM,CHANNEL_CONFIG(SPEAKER1_CHANNELS_NUM),0x00,0x00,0x00,
#if(SPEAKER1_CHANNELS_NUM == 1)
	0x09,0x24,0x06,0x0A,0x09,0x01,0x01,0x02,0x00,
#else
	0x0A,0x24,0x06,0x0A,0x09,0x01,0x01,0x02,0x02,0x00,
#endif
	0x09,0x24,0x03,0x0B,0x02,0x03,0x00,0x0A,0x00,
	...
	0x11,0x24,0x02,0x01,SPEAKER1_CHANNELS_NUM,SPEAKER1_ALT1_BITS,SPEAKER1_ALT1_BITS*8,0x03,SAMPLE_FREQ(USBD_SPEAKER1_FREQ),SAMPLE_FREQ(USBD_SPEAKER1_FREQ1),SAMPLE_FREQ(USBD_SPEAKER1_FREQ1),
	0x09,0x05,DEVICE_ISO_OUT_EP1,0x09,AUDIO_EP_MAX_SZE(USBD_SPEAKER1_FREQ,SPEAKER1_CHANNELS_NUM,SPEAKER1_ALT1_BITS),0x01,0x00,0x00,
	0x07,0x25,0x01,0x01,0x00,0x00,0x00,

#ifdef SPEAKER1_ALT2_EN
	0x09,0x04,0x06,0x02,0x01,0x01,0x02,0x00,0x00,
	0x07,0x24,0x01,0x09,0x01,0x01,0x00,
	0x11,0x24,0x02,0x01,SPEAKER1_CHANNELS_NUM,SPEAKER1_ALT2_BITS,SPEAKER1_ALT2_BITS*8,0x03,SAMPLE_FREQ(USBD_SPEAKER1_FREQ),SAMPLE_FREQ(USBD_SPEAKER1_FREQ1),SAMPLE_FREQ(USBD_SPEAKER1_FREQ1),
	0x09,0x05,DEVICE_ISO_OUT_EP1,0x09,AUDIO_EP_MAX_SZE(USBD_SPEAKER1_FREQ,SPEAKER1_CHANNELS_NUM,SPEAKER1_ALT2_BITS),0x01,0x00,0x00,
	0x07,0x25,0x01,0x01,0x00,0x00,0x00,
#endif

};
const uint8_t InterFaceNum_Tab(AUDIO_MIC_AUDIO)[] = {0xFF,0x00,0x01,0x02,0x03,0x04,0x06};
...
const uint8_t * const ConfigDescriptorTab[8] =
{
	...
	ConfigDescriptor_Tab(AUDIO_MIC_AUDIO),
...
const uint8_t * const InterFaceNumTab[8] =
{
	...
	InterFaceNum_Tab(AUDIO_MIC_AUDIO),
