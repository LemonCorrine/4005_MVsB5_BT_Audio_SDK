...
#define ROBOEFFECT_EFF_IF_NAME_SCRATCH(a) roboeffect_##a##_scratch_size

//CC_TODO: effects attributes template
const roboeffect_effect_property_struct effect_property_for_robo[] = {

	{ROBOEFFECT_AUTO_TUNE, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_AUTO_TUNE_PARAM_LEN, sizeof(AutoTuneContext24),
#if AUTO_TUNE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(auto_tune), ROBOEFFECT_EFF_IF_NAME_CONF(auto_tune), ROBOEFFECT_EFF_IF_NAME_APPLY(auto_tune), NULL,
#else
	...
	{ROBOEFFECT_DC_BLOCKER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_DC_BLOCKER_PARAM_LEN, sizeof(DCBlocker),
#if DC_BLOCKER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(dc_blocker), ROBOEFFECT_EFF_IF_NAME_CONF(dc_blocker), ROBOEFFECT_EFF_IF_NAME_APPLY(dc_blocker), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*DC_BLOCKER_ENABLE*/
	},

	{ROBOEFFECT_DRC, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_DRC_PARAM_LEN, sizeof(DRCContext),
#if DRC_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(drc), ROBOEFFECT_EFF_IF_NAME_CONF(drc), ROBOEFFECT_EFF_IF_NAME_APPLY(drc), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*DRC_ENABLE*/
	},

	{ROBOEFFECT_ECHO, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_ECHO_PARAM_LEN, sizeof(EchoContext),
#if ECHO_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(echo), ROBOEFFECT_EFF_IF_NAME_CONF(echo), ROBOEFFECT_EFF_IF_NAME_APPLY(echo), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*ECHO_ENABLE*/
	},

	{ROBOEFFECT_EQ, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_EQ_PARAM_LEN, sizeof(EQContext),
#if EQ_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(eq), ROBOEFFECT_EFF_IF_NAME_CONF(eq), ROBOEFFECT_EFF_IF_NAME_APPLY(eq), ROBOEFFECT_EFF_IF_NAME_SCRATCH(eq),
#else
	...
	{ROBOEFFECT_NOISE_SUPPRESSOR_EXPANDER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_NOISE_SUPPRESSOR_EXPANDER_PARAM_LEN, sizeof(ExpanderContext),
#if NOISE_SUPPRESSOR_EXPANDER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(noise_suppressor_expander), ROBOEFFECT_EFF_IF_NAME_CONF(noise_suppressor_expander), ROBOEFFECT_EFF_IF_NAME_APPLY(noise_suppressor_expander), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*NOISE_SUPPRESSOR_EXPANDER_ENABLE*/
	},

	{ROBOEFFECT_FREQ_SHIFTER, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_FREQ_SHIFTER_PARAM_LEN, sizeof(FreqShifterContext),
#if FREQ_SHIFTER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(freq_shifter), ROBOEFFECT_EFF_IF_NAME_CONF(freq_shifter), ROBOEFFECT_EFF_IF_NAME_APPLY(freq_shifter), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*FREQ_SHIFTER_ENABLE*/
	},

	{ROBOEFFECT_HOWLING_SUPPRESSOR, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_HOWLING_SUPPRESSOR_PARAM_LEN, sizeof(HowlingContext),
#if HOWLING_SUPPRESSOR_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(howling_suppressor), ROBOEFFECT_EFF_IF_NAME_CONF(howling_suppressor), ROBOEFFECT_EFF_IF_NAME_APPLY(howling_suppressor), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*HOWLING_SUPPRESSOR_ENABLE*/
	},

	{ROBOEFFECT_NOISE_GATE, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_NOISE_GATE_PARAM_LEN, sizeof(NoiseGateCT),
#if NOISE_GATE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(noise_gate), ROBOEFFECT_EFF_IF_NAME_CONF(noise_gate), ROBOEFFECT_EFF_IF_NAME_APPLY(noise_gate), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*NOISE_GATE_ENABLE*/
	},

	{ROBOEFFECT_PITCH_SHIFTER, ROBOEFFECT_CH_MONO_STEREO, FZ_128|FZ_256, ROBOEFFECT_PITCH_SHIFTER_PARAM_LEN, sizeof(PSContext),
#if PITCH_SHIFTER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(pitch_shifter), ROBOEFFECT_EFF_IF_NAME_CONF(pitch_shifter), ROBOEFFECT_EFF_IF_NAME_APPLY(pitch_shifter), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*PITCH_SHIFTER_ENABLE*/
	},

	{ROBOEFFECT_REVERB, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_REVERB_PARAM_LEN, sizeof(ReverbContext),
#if REVERB_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(reverb), ROBOEFFECT_EFF_IF_NAME_CONF(reverb), ROBOEFFECT_EFF_IF_NAME_APPLY(reverb), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*REVERB_ENABLE*/
	},

	{ROBOEFFECT_SILENCE_DETECTOR, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_SILENCE_DETECTOR_PARAM_LEN, sizeof(SilenceDetectorContext),
#if SILENCE_DETECTOR_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(silence_detector), ROBOEFFECT_EFF_IF_NAME_CONF(silence_detector), ROBOEFFECT_EFF_IF_NAME_APPLY(silence_detector), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*SILENCE_DETECTOR_ENABLE*/
	},

	{ROBOEFFECT_THREE_D, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_THREE_D_PARAM_LEN, sizeof(ThreeDContext),
#if THREE_D_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(three_d), ROBOEFFECT_EFF_IF_NAME_CONF(three_d), ROBOEFFECT_EFF_IF_NAME_APPLY(three_d), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*THREE_D_ENABLE*/
	},

	{ROBOEFFECT_VIRTUAL_BASS, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_VIRTUAL_BASS_PARAM_LEN, sizeof(VBContext),
#if VIRTUAL_BASS_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(virtual_bass), ROBOEFFECT_EFF_IF_NAME_CONF(virtual_bass), ROBOEFFECT_EFF_IF_NAME_APPLY(virtual_bass), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*VIRTUAL_BASS_ENABLE*/
	},

	{ROBOEFFECT_VOICE_CHANGER, ROBOEFFECT_CH_MONO_STEREO, FZ_512, ROBOEFFECT_VOICE_CHANGER_PARAM_LEN, sizeof(VoiceChangerContext),
#if VOICE_CHANGER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(voice_changer), ROBOEFFECT_EFF_IF_NAME_CONF(voice_changer), ROBOEFFECT_EFF_IF_NAME_APPLY(voice_changer), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
	...
	ROBOEFFECT_EFF_IF_NAME_INIT(gain_control), ROBOEFFECT_EFF_IF_NAME_CONF(gain_control), ROBOEFFECT_EFF_IF_NAME_APPLY(gain_control), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*GAIN_CONTROL_ENABLE*/
	},

	{ROBOEFFECT_VOCAL_CUT, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_VOCAL_CUT_PARAM_LEN, sizeof(VocalCutContext),
#if VOCAL_CUT_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(vocal_cut), ROBOEFFECT_EFF_IF_NAME_CONF(vocal_cut), ROBOEFFECT_EFF_IF_NAME_APPLY(vocal_cut), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*VOCAL_CUT_ENABLE*/
	},

	{ROBOEFFECT_REVERB_PRO, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_REVERB_PRO_PARAM_LEN, MAX_REVERB_PRO_CONTEXT_SIZE_44100,
#if REVERB_PRO_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(reverb_pro), ROBOEFFECT_EFF_IF_NAME_CONF(reverb_pro), ROBOEFFECT_EFF_IF_NAME_APPLY(reverb_pro), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*REVERB_PRO_ENABLE*/
	},

	{ROBOEFFECT_VOICE_CHANGER_PRO, ROBOEFFECT_CH_MONO, FZ_128|FZ_256, ROBOEFFECT_VOICE_CHANGER_PRO_PARAM_LEN, sizeof(VoiceChangerProContext),
#if VOICE_CHANGER_PRO_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(voice_changer_pro), ROBOEFFECT_EFF_IF_NAME_CONF(voice_changer_pro), ROBOEFFECT_EFF_IF_NAME_APPLY(voice_changer_pro), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*VOICE_CHANGER_PRO_ENABLE*/
	},

	{ROBOEFFECT_PHASE_CONTROL, ROBOEFFECT_CH_MONO_STEREO, FZ_64|FZ_128|FZ_256, ROBOEFFECT_PHASE_CONTROL_PARAM_LEN, sizeof(PhaseShifterContext),
#if PHASE_CONTROL_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(phase_control), ROBOEFFECT_EFF_IF_NAME_CONF(phase_control), ROBOEFFECT_EFF_IF_NAME_APPLY(phase_control), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
	...
	{ROBOEFFECT_PITCH_SHIFTER_PRO, ROBOEFFECT_CH_MONO_STEREO, FZ_128|FZ_256|FZ_512, ROBOEFFECT_PITCH_SHIFTER_PRO_PARAM_LEN, sizeof(PitchShifterProContext),
#if PITCH_SHIFTER_PRO_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(pitch_shifter_pro), ROBOEFFECT_EFF_IF_NAME_CONF(pitch_shifter_pro), ROBOEFFECT_EFF_IF_NAME_APPLY(pitch_shifter_pro), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*PITCH_SHIFTER_PRO_ENABLE*/
	},

	{ROBOEFFECT_VIRTUAL_BASS_CLASSIC, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_VIRTUAL_BASS_CLASSIC_PARAM_LEN, sizeof(VBClassicContext),
#if VIRTUAL_BASS_CLASSIC_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(virtual_bass_classic), ROBOEFFECT_EFF_IF_NAME_CONF(virtual_bass_classic), ROBOEFFECT_EFF_IF_NAME_APPLY(virtual_bass_classic), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*VIRTUAL_BASS_CLASSIC_ENABLE*/
	},

	{ROBOEFFECT_PCM_DELAY, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_PCM_DELAY_PARAM_LEN, sizeof(PCMDelay),
#if PCM_DELAY_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(pcm_delay), ROBOEFFECT_EFF_IF_NAME_CONF(pcm_delay), ROBOEFFECT_EFF_IF_NAME_APPLY(pcm_delay), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*PCM_DELAY_ENABLE*/
	},

	{ROBOEFFECT_HARMONIC_EXCITER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_HARMONIC_EXCITER_PARAM_LEN, sizeof(ExciterContext),
#if HARMONIC_EXCITER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(harmonic_exciter), ROBOEFFECT_EFF_IF_NAME_CONF(harmonic_exciter), ROBOEFFECT_EFF_IF_NAME_APPLY(harmonic_exciter), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*HARMONIC_EXCITER_ENABLE*/
	},

	{ROBOEFFECT_CHORUS, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_CHORUS_PARAM_LEN, sizeof(ChorusContext),
#if CHORUS_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(chorus), ROBOEFFECT_EFF_IF_NAME_CONF(chorus), ROBOEFFECT_EFF_IF_NAME_APPLY(chorus), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*CHORUS_ENABLE*/
	},

	{ROBOEFFECT_AUTO_WAH, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_AUTO_WAH_PARAM_LEN, sizeof(AutoWahContext),
#if AUTO_WAH_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(auto_wah), ROBOEFFECT_EFF_IF_NAME_CONF(auto_wah), ROBOEFFECT_EFF_IF_NAME_APPLY(auto_wah), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*AUTO_WAH_ENABLE*/
	},

	{ROBOEFFECT_STEREO_WIDENER, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_STEREO_WIDENER_PARAM_LEN, sizeof(StereoWidenerContext),
#if STEREO_WIDENER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(stereo_widener), ROBOEFFECT_EFF_IF_NAME_CONF(stereo_widener), ROBOEFFECT_EFF_IF_NAME_APPLY(stereo_widener), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*STEREO_WIDENER_ENABLE*/
	},

	{ROBOEFFECT_PINGPONG, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_PINGPONG_PARAM_LEN, sizeof(PingPongContext),
#if PINGPONG_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(pingpong), ROBOEFFECT_EFF_IF_NAME_CONF(pingpong), ROBOEFFECT_EFF_IF_NAME_APPLY(pingpong), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*PINGPONG_ENABLE*/
	},

	{ROBOEFFECT_THREE_D_PLUS, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_THREE_D_PLUS_PARAM_LEN, sizeof(ThreeDPlusContext),
#if THREE_D_PLUS_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(three_d_plus), ROBOEFFECT_EFF_IF_NAME_CONF(three_d_plus), ROBOEFFECT_EFF_IF_NAME_APPLY(three_d_plus), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*THREE_D_PLUS_ENABLE*/
	},

	{ROBOEFFECT_SINE_GENERATOR, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_SINE_GENERATOR_PARAM_LEN, sizeof(Sine32GenContext),
#if SINE_GENERATOR_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(sine_generator), ROBOEFFECT_EFF_IF_NAME_CONF(sine_generator), ROBOEFFECT_EFF_IF_NAME_APPLY(sine_generator), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*SINE_GENERATOR_ENABLE*/
	},

	{ROBOEFFECT_NOISE_SUPPRESSOR_BLUE, ROBOEFFECT_CH_MONO, FZ_128|FZ_256|FZ_512, ROBOEFFECT_NOISE_SUPPRESSOR_BLUE_PARAM_LEN, sizeof(BlueNSContext512),
#if NOISE_SUPPRESSOR_BLUE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(noise_suppressor_blue), ROBOEFFECT_EFF_IF_NAME_CONF(noise_suppressor_blue), ROBOEFFECT_EFF_IF_NAME_APPLY(noise_suppressor_blue), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*NOISE_SUPPRESSOR_BLUE_ENABLE*/
	},

	{ROBOEFFECT_FLANGER, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_FLANGER_PARAM_LEN, sizeof(FlangerContext24),
#if FLANGER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(flanger), ROBOEFFECT_EFF_IF_NAME_CONF(flanger), ROBOEFFECT_EFF_IF_NAME_APPLY(flanger), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*FLANGER_ENABLE*/
	},

	{ROBOEFFECT_FREQ_SHIFTER_FINE, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_FREQ_SHIFTER_FINE_PARAM_LEN, sizeof(FreqShifterFineContext),
#if FREQ_SHIFTER_FINE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(freq_shifter_fine), ROBOEFFECT_EFF_IF_NAME_CONF(freq_shifter_fine), ROBOEFFECT_EFF_IF_NAME_APPLY(freq_shifter_fine), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*FREQ_SHIFTER_FINE_ENABLE*/
	},

	{ROBOEFFECT_OVER_DRIVE, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_OVER_DRIVE_PARAM_LEN, sizeof(OverdriveContext),
#if OVER_DRIVE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(over_drive), ROBOEFFECT_EFF_IF_NAME_CONF(over_drive), ROBOEFFECT_EFF_IF_NAME_APPLY(over_drive), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*OVER_DRIVE_ENABLE*/
	},

	{ROBOEFFECT_DISTORTION_DS1, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_DISTORTION_DS1_PARAM_LEN, sizeof(DistortionDS1Context),
#if DISTORTION_DS1_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(distortion_ds1), ROBOEFFECT_EFF_IF_NAME_CONF(distortion_ds1), ROBOEFFECT_EFF_IF_NAME_APPLY(distortion_ds1), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*DISTORTION_DS1_ENABLE*/
	},

	{ROBOEFFECT_EQ_DRC, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_EQ_DRC_PARAM_LEN, sizeof(EQDRCContext),
#if EQ_DRC_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(eq_drc), ROBOEFFECT_EFF_IF_NAME_CONF(eq_drc), ROBOEFFECT_EFF_IF_NAME_APPLY(eq_drc), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*EQ_DRC_ENABLE*/
	},

	{ROBOEFFECT_AEC, ROBOEFFECT_CH_MONO, FZ_64, ROBOEFFECT_AEC_PARAM_LEN, sizeof(BlueAECContext),
#if AEC_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(aec), ROBOEFFECT_EFF_IF_NAME_CONF(aec), ROBOEFFECT_EFF_IF_NAME_APPLY(aec), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*AEC_ENABLE*/
	},

	{ROBOEFFECT_COMPANDER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_COMPANDER_PARAM_LEN, sizeof(CompanderContext),
#if COMPANDER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(compander), ROBOEFFECT_EFF_IF_NAME_CONF(compander), ROBOEFFECT_EFF_IF_NAME_APPLY(compander), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*COMPANDER_ENABLE*/
	},

	{ROBOEFFECT_LOW_LEVEL_COMPRESSOR, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_LOW_LEVEL_COMPRESSOR_PARAM_LEN, sizeof(LowLevelCompressorContext),
#if LOW_LEVEL_COMPRESSOR_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(low_level_compressor), ROBOEFFECT_EFF_IF_NAME_CONF(low_level_compressor), ROBOEFFECT_EFF_IF_NAME_APPLY(low_level_compressor), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*LOW_LEVEL_COMPRESSOR_ENABLE*/
	},

	{ROBOEFFECT_BEAT_TRACKER, ROBOEFFECT_CH_MONO_STEREO, FZ_512, ROBOEFFECT_BEAT_TRACKER_PARAM_LEN, sizeof(BeatTrackerContext),
#if BEAT_TRACKER_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(beat_tracker), ROBOEFFECT_EFF_IF_NAME_CONF(beat_tracker), ROBOEFFECT_EFF_IF_NAME_APPLY(beat_tracker), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*BEAT_TRACKER_ENABLE*/
	},

	{ROBOEFFECT_ENGINE_SOUND, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_ENGINE_SOUND_PARAM_LEN, sizeof(EngineSoundContextWrap),
#if ENGINE_SOUND_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(engine_sound), ROBOEFFECT_EFF_IF_NAME_CONF(engine_sound), ROBOEFFECT_EFF_IF_NAME_APPLY(engine_sound), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*ENGINE_SOUND_ENABLE*/
	},

	{ROBOEFFECT_BIQUAD, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_BIQUAD_PARAM_LEN, sizeof(BiquadContext),
#if BIQUAD_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(biquad), ROBOEFFECT_EFF_IF_NAME_CONF(biquad), ROBOEFFECT_EFF_IF_NAME_APPLY(biquad), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*BIQUAD_ENABLE*/
	},

	{ROBOEFFECT_CHORUS2, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_CHORUS2_PARAM_LEN, sizeof(Chorus2Context24),
#if CHORUS2_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(chorus2), ROBOEFFECT_EFF_IF_NAME_CONF(chorus2), ROBOEFFECT_EFF_IF_NAME_APPLY(chorus2), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*CHORUS2_ENABLE*/
	},

	{ROBOEFFECT_REVERB_PLATE, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_REVERB_PLATE_PARAM_LEN, sizeof(ReverbPlate24Context),
#if REVERB_PLATE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(reverb_plate), ROBOEFFECT_EFF_IF_NAME_CONF(reverb_plate), ROBOEFFECT_EFF_IF_NAME_APPLY(reverb_plate), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*REVERB_PLATE_ENABLE*/
	},

	{ROBOEFFECT_HOWLING_SUPPRESSOR_FINE, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_HOWLING_SUPPRESSOR_FINE_PARAM_LEN, (sizeof(HowlingFineContext)),
#if HOWLING_SUPPRESSOR_FINE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(howling_suppressor_fine), ROBOEFFECT_EFF_IF_NAME_CONF(howling_suppressor_fine), ROBOEFFECT_EFF_IF_NAME_APPLY(howling_suppressor_fine), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*HOWLING_SUPPRESSOR_FINE_ENABLE*/
	},

	{ROBOEFFECT_HOWLING_GUARD, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_HOWLING_GUARD_PARAM_LEN, (sizeof(HowlingGuardContext)),
#if HOWLING_GUARD_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(howling_guard), ROBOEFFECT_EFF_IF_NAME_CONF(howling_guard), ROBOEFFECT_EFF_IF_NAME_APPLY(howling_guard), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*HOWLING_GUARD_ENABLE*/
	},

	{ROBOEFFECT_VIRTUAL_BASS_TD, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_VIRTUAL_BASS_TD_PARAM_LEN, sizeof(VBTDContext),
#if VIRTUAL_BASS_TD_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(virtual_bass_td), ROBOEFFECT_EFF_IF_NAME_CONF(virtual_bass_td), ROBOEFFECT_EFF_IF_NAME_APPLY(virtual_bass_td), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*VIRTUAL_BASS_TD_ENABLE*/
	},

	{ROBOEFFECT_OVER_DRIVE_PLOY, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_OVER_DRIVE_PLOY_PARAM_LEN, sizeof(OverdrivePolyContext),
#if OVER_DRIVE_PLOY_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(over_drive_ploy), ROBOEFFECT_EFF_IF_NAME_CONF(over_drive_ploy), ROBOEFFECT_EFF_IF_NAME_APPLY(over_drive_ploy), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*OVER_DRIVE_PLOY_ENABLE*/
	},

	{ROBOEFFECT_TREMOLO, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_TREMOLO_PARAM_LEN, sizeof(TremoloContext),
#if TREMOLO_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(tremolo), ROBOEFFECT_EFF_IF_NAME_CONF(tremolo), ROBOEFFECT_EFF_IF_NAME_APPLY(tremolo), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*TREMOLO_ENABLE*/
	},

	{ROBOEFFECT_BEAMFORMING, ROBOEFFECT_CH_STEREO, FZ_128, ROBOEFFECT_BEAMFORMING_PARAM_LEN, sizeof(BeamformingContext),
#if BEAMFORMING_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(beamforming), ROBOEFFECT_EFF_IF_NAME_CONF(beamforming), ROBOEFFECT_EFF_IF_NAME_APPLY(beamforming), NULL,
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), NULL,
#endif/*BEAMFORMING_ENABLE*/
	},

	{ROBOEFFECT_FADER, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_FADER_PARAM_LEN, sizeof(roboeffect_fader_context_inner),
	ROBOEFFECT_EFF_IF_NAME_INIT(fader), ROBOEFFECT_EFF_IF_NAME_CONF(fader), ROBOEFFECT_EFF_IF_NAME_APPLY(fader), NULL,
	},

	{ROBOEFFECT_DOWNMIX_2TO1, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_DOWNMIX_2TO1_PARAM_LEN, 4,
	ROBOEFFECT_EFF_IF_NAME_INIT(downmix_2to1), ROBOEFFECT_EFF_IF_NAME_CONF(downmix_2to1), ROBOEFFECT_EFF_IF_NAME_APPLY(downmix_2to1), NULL,
	},

	{ROBOEFFECT_UPMIX_1TO2, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_UPMIX_1TO2_PARAM_LEN, 4,
	ROBOEFFECT_EFF_IF_NAME_INIT(upmix_1to2), ROBOEFFECT_EFF_IF_NAME_CONF(upmix_1to2), ROBOEFFECT_EFF_IF_NAME_APPLY(upmix_1to2), NULL,
	},

	{ROBOEFFECT_CHANNEL_COMBINER, ROBOEFFECT_CH_STEREO, FZ_ANY, ROBOEFFECT_CHANNEL_COMBINER_PARAM_LEN, 4,
	ROBOEFFECT_EFF_IF_NAME_INIT(channel_combiner), ROBOEFFECT_EFF_IF_NAME_CONF(channel_combiner), ROBOEFFECT_EFF_IF_NAME_APPLY(channel_combiner), NULL,
	},

	{ROBOEFFECT_CHANNEL_SELECTOR, ROBOEFFECT_CH_MONO, FZ_ANY, ROBOEFFECT_CHANNEL_SELECTOR_PARAM_LEN, 4,
	ROBOEFFECT_EFF_IF_NAME_INIT(channel_selector), ROBOEFFECT_EFF_IF_NAME_CONF(channel_selector), ROBOEFFECT_EFF_IF_NAME_APPLY(channel_selector), NULL,
	},
...
0x01, 0x01, 0x01, //dc_blocker@1.1.1
...
0x01, 0x07, 0x07, //pitch_shifter@1.7.7
...
0x01, 0x02, 0x00, //silence_detector@1.2.0
...
0x02, 0x05, 0x00, //voice_changer_pro@2.5.0
...
0x02, 0x02, 0x00, //pitch_shifter_pro@2.2.0
0x11, //effect name length
...
0x01, 0x01, 0x00, //engine_sound@1.1.0
0x0C, //effect name length
...
0x02, 0x02, 0x00, //reverb_plate@2.2.0
0x0C, //effect name length
...
0x0B, //unit length 11
0x6D, 0x69, 0x6C, 0x6C, 0x69, 0x6D, 0x65, 0x74, 0x65, 0x72, 0x73, 
0x00, //fract 0
0x01, 0x00, //ratio 1
0x00, //tips length 0
...
0x06, //unit length 6
0x66, 0x72, 0x61, 0x6D, 0x65, 0x73, 
0x00, //fract 0
0x01, 0x00, //ratio 1
0x15, //tips length 21
0x66, 0x61, 0x64, 0x65, 0x72, 0x20, 0x73, 0x74, 0x65, 0x70, 0x73, 0x20, 0x69, 0x6E, 0x20, 0x66, 0x72, 0x61, 0x6D, 0x65, 0x73, 
