...
const roboeffect_effect_property_struct effect_property_for_robo[] = {
	...
	{ROBOEFFECT_DRC_LEGACY, ROBOEFFECT_CH_MONO_STEREO, FZ_ANY, ROBOEFFECT_DRC_LEGACY_PARAM_LEN, 4,
...
0x41, 0x00, //item len=65
0x03, 0x00, 0x00, //noise_suppressor_blue@3.0.0
...
/*****drc_legacy*****/
0x30, 0x03, //item len=816
0x03, 0x01, 0x01, //drc_legacy@3.1.1
0x0A, //effect name length
0x64, 0x72, 0x63, 0x5F, 0x6C, 0x65, 0x67, 0x61, 0x63, 0x79, 
0x00, //effect category
0x02, //bits width is 16/24
0x01, //input counter
